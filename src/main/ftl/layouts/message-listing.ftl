...
<#-- Show unless includeIfEmpty is false and messageListingResult is empty -->
<#if !(includeIfEmpty?? && !includeIfEmpty && messageListingResult?? && messageListingResult.size() <= 0)>
