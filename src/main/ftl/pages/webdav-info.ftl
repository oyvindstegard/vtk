...
<div id="vrtx-webdavmessage" class="infomessage webdavmessage">
  ...
  <a href="http://www.webdavsystem.com/server/access/macosx">Finder in MacOSX</a>. 
  On Linux you have to use <a href="http://www.webdav.org/cadaver">Cadaver</a>, a command-line WebDAV client.
</div>
