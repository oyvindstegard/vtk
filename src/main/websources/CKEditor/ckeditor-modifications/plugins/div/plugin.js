			...
			if ( editor.addMenuItems ) {
				...
				if ( editor.contextMenu ) {
					editor.contextMenu.addListener( function( element ) {
                        ...
                        // USIT Preview (VTK-3873) - remove 'editdiv'-option from contextmenu if old image div-container
                        var divElm = CKEDITOR.plugins.div.getSurroundDiv( editor );
						if ( divElm ) {
						    var divElmClassName = divElm.$.className;
						    if( divElmClassName.indexOf("vrtx-container ") === -1
						     && divElmClassName.indexOf("vrtx-img-container ") === -1) {
						         return {
